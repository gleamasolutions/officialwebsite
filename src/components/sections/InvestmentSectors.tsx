      ...
      <Container className="relative">
        <FadeIn>
          <SectionTitle
            ...
            subtitle="A diversified portfolio across four strategic investment verticals, each managed with institutional rigor and long-term vision."
            align="center"
            className="mb-14"
          />
        </FadeIn>
            ...
            return (
              <motion.div key={sector.href} variants={cardVariants} role="listitem">
                ...
                >
                  ...
                  <h3 className="text-heading-sm font-semibold text-primary transition-colors group-hover:text-primary/90">
                    {sector.title}
                  </h3>
